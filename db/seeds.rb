...
track("AERIALS_INT1", name: "Aerials - Intermedios 1", course_kind: "swing")
track("AERIALS_PRIN", name: "Aerials - Principiantes", course_kind: "swing")
track("AJ_AVAN", name: "Authentic Jazz - Avanzados", course_kind: "swing")
track("AJ_INT1", name: "Authentic Jazz - Intermedios 1", course_kind: "swing")
track("AJ_PRIN", name: "Authentic Jazz - Principiantes", course_kind: "swing")
track("SHAG", name: "Shag", course_kind: "swing")
track("SHAG_PRIN", name: "Shag - Principiantes", course_kind: "swing")
track("SHAG_INT1", name: "Shag - Intermedios 1", course_kind: "swing")
track("BALBOA", name: "Balboa", course_kind: "swing")
track("BALBOA_SHAG", name: "Balboa/Shag/20's", course_kind: "swing")
track("BLUES_INT1", name: "Blues - Intermedios 1", course_kind: "swing")
track("BLUES_PRIN", name: "Blues - Principiantes", course_kind: "swing")
track("ESTIRAMIENTO", name: "Estiramiento", course_kind: "swing")
track("INTRO_BAILE", name: "Intro al Baile", course_kind: "swing")
track("LH_AVAN", name: "Lindy Hop - Avanzados", course_kind: "swing")
track("LH_AVAN2", name: "Lindy Hop - Avanzados 2", course_kind: "swing")
track("LH_COREO", name: "Lindy Hop Coreo", course_kind: "swing")
track("LH_INT1", name: "Lindy Hop - Intermedios 1", course_kind: "swing")
track("LH_INT1_PLUS", name: "Lindy Hop - Intermedios 1+", course_kind: "swing")
track("LH_INT2", name: "Lindy Hop - Intermedios 2", course_kind: "swing")
track("LH_INT2_PLUS", name: "Lindy Hop - Intermedios 2+", course_kind: "swing")
track("LH_INT3", name: "Lindy Hop - Intermedios 3", course_kind: "swing")
track("LH_INT3_PLUS", name: "Lindy Hop - Intermedios 3+", course_kind: "swing")
track("LH_PRIN", name: "Lindy Hop - Principiantes", course_kind: "swing")
track("LH_PRIN_PLUS", name: "Lindy Hop - Principiantes+", course_kind: "swing")
track("PREP_FISICA", name: "Preparación Física", course_kind: "swing")
track("SWING_KIDS", name: "Swing Kids", course_kind: "swing")
track("SWING_SENIOR", name: "Swing Senior", course_kind: "swing")
track("TAP_KIDS", name: "Tap Kids", course_kind: "swing")
track("TP_AVAN", name: "Tap - Avanzados", course_kind: "swing")
track("TP_INT1", name: "Tap - Intermedios 1", course_kind: "swing")
track("TP_INT2", name: "Tap - Intermedios 2", course_kind: "swing")
track("TP_PRIN", name: "Tap - Principiantes", course_kind: "swing")
track("TALLER", name: "Entendiendo la Música", course_kind: "swing")

track("LOCKING", name: "Locking", course_kind: "roots")
track("HOUSE", name: "House", course_kind: "roots")
track("WAACKING", name: "Waacking", course_kind: "roots")
track("POPPING", name: "Popping", course_kind: "roots")
track("BREAKING", name: "Breaking", course_kind: "roots")
track("HIP_HOP_PRIN", name: "Hip Hop - Principiantes", course_kind: "roots")
track("HIP_HOP_INT", name: "Hip Hop - Intermedios", course_kind: "roots")
track("AFRO_URBANO", name: "Afro Urbano", course_kind: "roots")

track("DANZA_AFRO", name: "Danza Afro", course_kind: "afro")
...
payment_plan "LIBRE", description: "Swing: 1 Mes. Libre $2800", price: 2800, weekly_classes: 40, order: 1, course_match: "swing"
payment_plan "2_MESES_LIBRE", description: "Swing: 2 Meses. Libre $4600", price: 4600, weekly_classes: 40, order: 1, course_match: "swing"
payment_plan "3_MESES", description: "Swing: 3 Meses 1 x Semana $1950", price: 1950, weekly_classes: 1, order: 1, course_match: "swing"
payment_plan "3_X_SEMANA", description: "Swing: Mensual 3 x Semana $1900", price: 1900, weekly_classes: 3, order: 1, course_match: "swing"
payment_plan "2_X_SEMANA", description: "Swing: Mensual 2 x Semana $1700", price: 1700, weekly_classes: 2, order: 1, course_match: "swing"
payment_plan "1_X_SEMANA_3", description: "Swing: Mensual 1 x Semana (3 c) $680", price: 680, weekly_classes: 1, order: 1, course_match: "swing"
payment_plan "1_X_SEMANA_4", description: "Swing: Mensual 1 x Semana (4 c) $900", price: 900, weekly_classes: 1, order: 1, course_match: "swing"
payment_plan "1_X_SEMANA_5", description: "Swing: Mensual 1 x Semana (5 c) $1120", price: 1120, weekly_classes: 1, order: 1, course_match: "swing"
payment_plan PaymentPlan::SINGLE_CLASS, description: "Swing: Clase suelta $270", price: 270, weekly_classes: 1, order: 1, course_match: "swing"
...
payment_plan PaymentPlan::SINGLE_CLASS_ROOTS, description: "Roots: Clase suelta $270", price: 270, weekly_classes: 1, order: 2, course_match: "roots"
payment_plan "ROOTS__1_X_SEMANA", description: "Roots: Mensual 1 x Semana $900", price: 900, weekly_classes: 1, order: 2, course_match: "roots"
payment_plan "ROOTS__2_X_SEMANA", description: "Roots: Mensual 2 x Semana $1700", price: 1700, weekly_classes: 2, order: 2, course_match: "roots"
payment_plan "ROOTS__3_X_SEMANA", description: "Roots: Mensual 3 x Semana $2200", price: 2200, weekly_classes: 3, order: 2, course_match: "roots"

payment_plan PaymentPlan::SINGLE_CLASS_AFRO, description: "Roots: Clase suelta de Danza Afro $300", price: 300, weekly_classes: 1, order: 3, course_match: "afro"
payment_plan "AFRO__1_X_SEMANA", description: "Roots: Mensual 1 x Semana de Danza Afro $1100", price: 1100, weekly_classes: 1, order: 3, course_match: "afro"
payment_plan "AFRO-1ROOTS__2_X_SEMANA", description: "Roots: Mensual 2 x Semana con Danza Afro $1800", price: 1800, weekly_classes: 1, order: 3, course_match: "afro,roots"
payment_plan "AFRO-2ROOTS__3_X_SEMANA", description: "Roots: Mensual 3 x Semana con Danza Afro $2600", price: 2600, weekly_classes: 1, order: 3, course_match: "afro,roots"
