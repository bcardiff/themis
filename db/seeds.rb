...
payment_plan "1_X_SEMANA_4_SALE_30", description: "Swing: Mensual 1 x Semana (4 c) -30%", price: 630, weekly_classes: 1, order: 1, course_match: "swing"
payment_plan "1_X_SEMANA_4_SALE_50", description: "Swing: Mensual 1 x Semana (4 c) -50%", price: 450, weekly_classes: 1, order: 1, course_match: "swing"
...
payment_plan PaymentPlan::SINGLE_CLASS_FREE, description: "Swing: Clase bonificada", price: 0, weekly_classes: 1, order: 1, course_match: "swing"

payment_plan PaymentPlan::SINGLE_CLASS_ROOTS, description: "Roots: Clase suelta", price: 270, weekly_classes: 1, order: 2, course_match: "roots"
payment_plan "ROOTS__1_X_SEMANA", description: "Roots: Mensual 1 x Semana", price: 900, weekly_classes: 1, order: 2, course_match: "roots"
payment_plan "ROOTS__2_X_SEMANA", description: "Roots: Mensual 2 x Semana", price: 1700, weekly_classes: 2, order: 2, course_match: "roots"
payment_plan "ROOTS__3_X_SEMANA", description: "Roots: Mensual 3 x Semana", price: 2200, weekly_classes: 3, order: 2, course_match: "roots"

payment_plan PaymentPlan::SINGLE_CLASS_AFRO, description: "Roots: Clase suelta de Danza Afro", price: 300, weekly_classes: 1, order: 3, course_match: "afro"
payment_plan "AFRO__1_X_SEMANA", description: "Roots: Mensual 1 x Semana de Danza Afro", price: 1100, weekly_classes: 1, order: 3, course_match: "afro"
payment_plan "AFRO-1ROOTS__2_X_SEMANA", description: "Roots: Mensual 2 x Semana con Danza Afro", price: 1800, weekly_classes: 1, order: 3, course_match: "afro,roots"
payment_plan "AFRO-2ROOTS__3_X_SEMANA", description: "Roots: Mensual 3 x Semana con Danza Afro", price: 2600, weekly_classes: 1, order: 3, course_match: "afro,roots"
